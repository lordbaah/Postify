...
const AdminAllPostsPage: React.FC = () => {
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold text-primary-dark mb-4">
        All Posts (Admin View)
      </h1>
      <p className="text-lg text-gray-700">View and moderate all blog posts.</p>
      <p className="mt-4 text-gray-600">This is an admin-only route.</p>
      {/* Placeholder for all posts list with moderation options */}
      <div className="mt-6 p-4 border border-dashed border-gray-300 rounded-lg text-gray-500">
        Table/list of all posts with edit/delete options will go here.
      </div>
    </div>
  );
};
